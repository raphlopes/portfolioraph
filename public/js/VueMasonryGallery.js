!function (e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && (define.amd || define.cmd) ? define([], t) : "object" == typeof exports ? exports.VueMasonryGallery = t() : e.VueMasonryGallery = t()
    ...
    return function (e) {
        ...
        var d = n(8), c = {}, u = l && (document.head || document.getElementsByTagName("head")[0]), f = null, A = 0,
            h = !1, p = function () {
        ...
        e.exports = function (e, t, n, i, a, r) {
            ...
            if (r ? (c = function (e) {
                ...
                var u = d.functional, f = u ? d.render : d.beforeCreate;
        ...
        t.a = {
            ...
            props: {
                ...
                reachBottomDistance: {type: Number, default: 0},
                ...
                cardAnimationClass: {type: [String], default: "default-card-animation"}
            },
            data: function () {
                return {
            ...
            mounted: function () {
                ...
                }), this.isMobile || this.width || this.response(), this.scroll()
            },
            watch: {
                isPreloading: function (e, t) {
                    ...
                    t.length > 0 && e[0] && !e[0]._height && this.reset(), this.preload()
                }
            },
            methods: {
                preload: function (e, t) {
                    ...
                    this.imgsArr.forEach(function (e, t) {
                        if (!(t < n.loadedCount)) {
                            if (!e[n.srcKey]) return n.imgsArr[t]._height = "0", void n.loadedCount++;
                            var i = new Image;
                            i.src = e[n.srcKey], i.onload = i.onerror = function (e) {
                                n.loadedCount++, n.imgsArr[t]._height = "load" == e.type ? Math.round(n.imgWidth_c / (i.width / i.height)) : n.imgWidth, n.loadedCount == n.imgsArr.length && n.$emit("preloaded")
                            }
                        }
                    })
                }, calcuCols: function () {
                    var e = this.width ? this.width : window.innerWidth, t = parseInt(e / this.colWidth);
                    ...
                    if (this.imgBoxEls) {
                        ...
                        for (var a = this.beginIndex; a < this.imgsArr.length; a++) {
                            ...
                            if (n = this.imgBoxEls[a].offsetHeight, a < this.cols) this.colsHeightArr.push(n), e = 0, t = a * i; else {
                                var r = Math.min.apply(null, this.colsHeightArr), s = this.colsHeightArr.indexOf(r);
                    ...
                    var e = this, t = Math.max.apply(null, this.colsHeightArr);
                    this.$nextTick(function () {
                        e.$refs.over.style.top = t + "px"
                    })
                }, bindClickEvent: function () {
                    var e = this;
                    this.$el.querySelector(".vue-masonry-gallery").addEventListener("click", function (t) {
                        var n = t.target;
                        if (-1 == n.className.indexOf("img-box")) {
                    ...
                    var e = this.$el.querySelector(".vue-masonry-gallery-scroll"), t = e.offsetWidth - e.clientWidth;
        ...
        "use strict";
        t.a = {
            name: "alink", props: ["to"], data: function () {
        ...
        var a = n(4), r = n(12), s = !1, o = n(2), l = i, d = o(a.a, r.a, !1, l, null, null);
        d.options.__file = "src\\components\\alink.vue", t.a = d.exports
    }, function (e, t, n) {
        var i = n(11);
        "string" == typeof i && (i = [[e.i, i, ""]]), i.locals && (e.exports = i.locals);
        n(1)("75b4b0a0", i, !1, {})
        ...
        var i = function () {
            ...
            return n("div", {
                ...
                }], staticClass: "loading ball-beat", class: {first: e.isFirstLoad}
            }, [e._t("loading", null, {isFirstLoad: e.isFirstLoad}), e._l(e.loadingDotCount, function (t) {
                return e.hasLoadingSlot ? e._e() : n("div", {staticClass: "dot", style: e.loadingDotStyle})
            })], 2), n("div", {
                ref: "scrollEl",
                staticClass: "vue-masonry-gallery-scroll"
            }, [e._t("masonry-head"), n("div", {
                ...
                return n("div", {
                    ...
                    attrs: {"data-index": i, to: "card" == e.linkRange && t[e.hrefKey]}
                }, [t[e.srcKey] ? n(e.isRouterLink && "img" == e.linkRange ? "router-link" : "alink", {
                    tag: "component",
                    staticClass: "img-wraper",
                    style: {width: e.imgWidth_c + "px", height: !!t._height && t._height + "px"},
                    attrs: {to: "img" == e.linkRange && t[e.hrefKey]}
                }, [n("img", {attrs: {src: t[e.srcKey]}})]) : e._e(), e._t("default", null, {
                    index: i,
                    value: t
                })], 2)], 1)
            }), e.over ? n("div", {
